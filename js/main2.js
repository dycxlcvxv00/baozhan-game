/* 爆战丨无限弹幕 v2.3 · BattleScene 渲染同步：按三区重算 */
'use strict';
...
BattleScene.prototype.sync=function(){
  var S=this.S,g=this.g,cfg=BZ.CONFIG,ui=BZ.UI||{topH:72,bottomH:112,battleTop:72,battleBottom:608,battleMidY:340},i;
  ...
  g.lineStyle(1,0x1e293b,.28);for(i=0;i<=26;i++)g.lineBetween(i*48,battleTop,i*48,battleBottom);for(i=0;i<=Math.ceil(battleH/48);i++)g.lineBetween(0,battleTop+i*48,W,battleTop+i*48);
