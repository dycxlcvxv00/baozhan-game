/* 爆战丨无限弹幕 v4.0 · BattleScene 渲染同步：真实视口完整显示 */
'use strict';
...
BattleScene.prototype.sync=function(){
  ...
  g.fillStyle(0x172554,.28).fillRoundedRect(18,battleTop+14,Math.max(24,cfg.wallX-42),Math.max(20,battleH-28),16);
  var wallColor=S.wallFlash>0?0xfef2f2:0x94a3b8;g.fillStyle(wallColor,1).fillRect(cfg.wallX-6,battleTop,12,battleH);if(S.shield>0)g.lineStyle(4,0x7dd3fc,.75).strokeRect(cfg.wallX-13,battleTop+6,26,battleH-12);
