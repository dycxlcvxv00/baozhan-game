/* 爆战丨无限弹幕 v2.6 · 架构层：GameState + GameBridge + BattleScene */
'use strict';
var W = 1280, H = 720;
var GameState = (function () {
  ...
  function buildHoneycombUiSlots(box){
    // v2.6：收回边界内；横向间距缩小、纵向间距适中，目标是视觉等距蜂窝。
    var cx=box.matrixX || box.centerX, cy=box.centerY, colGap=38, rowGap=40, innerGap=32, shift=19;
    var rows=[
  ...
  function getDividerUiLine(box){ return {x1:box.matrixX - 48, x2:box.dividerX || box.centerX + 44, y:box.centerY}; }
